...
export default function ButtonUploadPic({photoURL}) {
...
const onSend = async (downloadURL) =>{
    ...
    const todoUpdated = {...currentUser, photoURL:downloadURL}
...
{/* 
      ...
      {/* </Button> */}
      <MKButton onClick={handleClickOpen}  variant="outlined" color="info" size="small" style={{top:-100}}>
                  Edit profile Pic
                </MKButton>
      <Dialog
        open={open}
             ...
             <div className="max-w-4xl mx-auto p-20 space-y-6">
                    <label>
                        ...
                        {selectedImage ? (
                            ...
                            <Avatar sx={{ width: 80, height: 80 , alignItems:'center', alignSelf:'center'}} src={photoURL}/>
                        )}
                        </div>
                    </label>
