    ...
    if(chooseCat.length<1){
      ...
      if(todo.cost<=0){
        ...
        if(!todo.details){
          ...
          setListCat([])
          setChooseCat([])
          showAlert('success',`New request has been create successfully`)
        }
      }
                ...
                <MKBox component="form" p={2} method="post">
                  <MKBox px={3} py={{ xs: 2, sm: 6 }}>
                    ...
                    <MKTypography variant="body1" color="text" mb={2}>
                      Complete the form to create a request
                    </MKTypography>
                  </MKBox>
              ...
              >
                ...
                >
                  <MKBox py={6} pr={6} pl={{ xs: 6, sm: 12 }} my="auto">
                    ...
                    <MKTypography variant="body2" color="white" opacity={0.8} mb={3}>
                      The model will see the request and if she wants to do it, she will have to accept it.
                    </MKTypography>
                    <MKTypography variant="body2" color="white" opacity={0.8} mb={3}>
                      You will see the models interested in the request and choose which ones you want for doing it.
                    </MKTypography>
                    <MKTypography variant="body2" color="white" opacity={0.8} mb={3}>
                      You can chat with them about the job and eventually the models will send you the files.
                    </MKTypography>
                    <MKTypography variant="body2" color="white" opacity={0.8} mb={3}>
